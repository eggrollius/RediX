...
Db_return_code Database::set_value(const std::string &key, const std::string &value, std::string &res_msg) {
...
Db_return_code Database::get_value(const std::string &key, std::string &res_msg) const {
...
Db_return_code Database::del_entry(const std::string &key, std::string &res_msg) {
...
Db_return_code Database::set_ttl(const std::string &key, const int ttl, std::string &res_msg) {
